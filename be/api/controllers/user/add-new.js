module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      let check = await sails.helpers.user.checkPermissionOnCreateUser(sessionUser, inputs.userType, inputs.roleId);
      if (!check) {
      ...
      return exits.success({
        message: sails.__('Create new account success: ') + `Account: ${inputs.account}  --- Password: ${inputs.password}`,
      });
