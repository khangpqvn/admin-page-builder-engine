...
module.exports = {
  ...
  datastores: {
    ...
    default: {
      // adapter: 'sails-mysql',
      // url: 'mysql://root:Devmo+=123@localhost:3306/homestayprod',
      //--------------------------------------------------------------------------
   ...
   *                                                                          *
   * > If you have disabled the "session" hooks, then you can safely remove    *
  ...
  session: {
     ...
     *                                                                          *
     ***************************************************************************/
    // adapter: '@sailshq/connect-redis',//TODO: Config redis for production
   ...
   *                                                                          *
   * > If you have disabled the "sockets" hooks, then you can safely remove    *
   * > this section from your `config/env/production.js` file.                *
   *                                                                          *
   ***************************************************************************/
  sockets: {
